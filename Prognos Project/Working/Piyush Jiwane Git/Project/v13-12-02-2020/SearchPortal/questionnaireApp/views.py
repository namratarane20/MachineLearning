...
from .models import TagWithInfo, Search, RelevantResponseDatabase1, UserSessionDatabase, KeywordSearchedDatabase, MostFavouredResponseHistoryDatabase, FileUploadReport, Image
        ...
        if relaventData['MostRelevantResponses'] == '':
            ...
            for data in relevantDataFromDb:
                if data.user_Keyword == userKeyword.lower():
                    ...
                    break
            if not flag:
                RelevantResponseDatabase1(user_Keyword=userKeyword.lower(), count=1,
