...
urlpatterns = [
    ...
    path('slackNotification/<str:userName>/<int:questionID>',views.SlackNotification,name="slackNotification"),
    path('myUnanswered', views.MyUnanswered, name="myUnanswered")
]
