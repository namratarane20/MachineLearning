...
def SlackNotification(request,userName,questionID):
    ...
    if not re.search(userName.strip().lower(),assignToFilteredData.lower()):
        ...
        response = client.chat_postMessage(
            channel='#trainees-communication',
            text='Message from Security Audit Portal - @'+userName+' you have a question assigned by '+request.user.get_full_name()+' please visite to the link https://google.com')
