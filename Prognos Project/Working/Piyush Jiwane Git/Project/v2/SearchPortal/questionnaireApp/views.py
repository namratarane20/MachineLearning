...
str=""
def searchKeyword(request,recentSearch=None):
...
def addToTags(request):
    ...
    try:
        ...
        return render(request, 'questionnaireApp/demo.html', {'tagNameList':tagNameList,'newSearchTable':newSearchTable,'order':order})
